...
class NumberSpider(scrapy.Spider):
    ...
    def parse(self, response):
        """Parse the response and extract winning numbers."""
        ...
        for first in response.css('div[data-id="2526:6087"]'):
            ...
            clean_number1 = [n.replace("Property 1=", "").replace(",", "") for n in number_1]  # Clean numbers
        ...
        for second in response.css('div[data-id="2526:6088"]'):
            ...
            clean_number2 = [n.replace("Property 1=", "").replace(",", "") for n in number_2]  # Clean numbers
        ...
        for third in response.css('div[data-id="2526:6106"]'):
            ...
            clean_number3 = [n.replace("Property 1=", "").replace(",", "") for n in number_3]  # Clean numbers
    ...
    def save_to_db(self, date, first, second, third):
        ...
        try:
            # Remove commas from each element and join into strings
